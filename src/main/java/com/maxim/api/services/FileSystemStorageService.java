...
import com.maxim.api.exceptions.StorageException;
import com.maxim.api.exceptions.StorageFileNotFoundException;
import com.maxim.api.properties.StorageProperties;
import com.maxim.api.repositories.StorageRepository;
...
public class FileSystemStorageService implements StorageRepository {
    private Path rootLocation = Path.of("uploads");
